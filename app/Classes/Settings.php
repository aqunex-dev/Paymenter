    ...
    public static function settings()
    {
        ...
        $settings = [
            ...
            'social-login' => [
                ...
                [
                    'name' => 'oauth_oidc',
                    'label' => 'OpenID Connect Enabled',
                    'description' => new HtmlString('<a href="https://paymenter.org/docs/guides/OAuth#openid-connect" target="_blank">Documentation</a>'),
                    'type' => 'checkbox',
                    'database_type' => 'boolean',
                    'default' => false,
                    'required' => false,
                ...
                [
                    'name' => 'oauth_oidc_label',
                    'label' => 'OpenID Connect Label',
                    'description' => 'Text shown on the login button (the “~” in “Login with ~”). Example: “Keycloak”, “SSO”, “Company Login”.',
                    'type' => 'text',
                    'default' => 'OpenID Connect',
                    'required' => fn (Get $get) => (bool) $get('oauth_oidc'),
                    'placeholder' => 'OpenID Connect',
                ],
                [
                    'name' => 'oauth_oidc_base_url',
                    'label' => 'OpenID Connect Base URL (Issuer)',
                    'description' => new HtmlString('Issuer base URL. Discovery is at <code>{base_url}/.well-known/openid-configuration</code>. Must be <code>https://</code> (http allowed only for localhost). Example: <code>https://id.example.com</code> or <code>https://id.example.com/realms/myrealm</code>.'),
                    'type' => 'text',
                    'required' => fn (Get $get) => (bool) $get('oauth_oidc'),
                    'validation' => 'url',
                ...
                [
                    'name' => 'oauth_oidc_scopes',
                    'label' => 'OpenID Connect Scopes',
                    'description' => 'Space or comma separated. Defaults to “openid email profile”. OpenID is always included.',
                    'type' => 'text',
                    'required' => false,
